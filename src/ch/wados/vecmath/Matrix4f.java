...
public class Matrix4f {
	 ...
	 */
	public float[] getGLArray() {
		return new float[] { this.m00, this.m10, this.m20, this.m30, this.m01, this.m11, this.m21, this.m31, this.m02,
	...
	public static Matrix4f rotate(float angle, float x, float y, float z) {
		...
		float z_norm = z / length;

		rotation.m00 = x_norm * x_norm * (1f - cos) + cos;
		rotation.m10 = y_norm * x_norm * (1f - cos) + z_norm * sin;
		rotation.m20 = x_norm * z_norm * (1f - cos) - y_norm * sin;
		rotation.m01 = x_norm * y_norm * (1f - cos) - z_norm * sin;
		rotation.m11 = y_norm * y_norm * (1f - cos) + cos;
		rotation.m21 = y_norm * z_norm * (1f - cos) + x_norm * sin;
		rotation.m02 = x_norm * z_norm * (1f - cos) + y_norm * sin;
		rotation.m12 = y_norm * z_norm * (1f - cos) - x_norm * sin;
		rotation.m22 = z_norm * z_norm * (1f - cos) + cos;
