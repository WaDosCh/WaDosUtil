...
public class UdpConfig {
	 ...
	 */
	private static final boolean[]	DEBUG_LEVEL	 = new boolean[] {
	 ...
	 * otherwise if any parts are missing a maximal time of REQUEST_MISSING_MS is
	 * spent before a request is sent
	 */
